...
public class DisconnectedGraph : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        ...
        _edges.Add(new Edge<GameObject>(_nodes[5], _nodes[6]));
        _edges.Add(new Edge<GameObject>(_nodes[6], _nodes[7]));
        _edges.Add(new Edge<GameObject>(_nodes[7], _nodes[5]));
